    ...
    <>
      ...
      <main className="container">
        ...
        <section className="form-section" ref={formRef}>
          <div className="form-wrapper">
            <div className="form-intro">
              ...
              <p>
                Obtenez votre audit gratuit et découvrez le potentiel caché de votre réputation
                Google.
              </p>
            </div>
            <LeadForm />
        ...
        <section className="closing-cta">
          ...
          <p>
            Rejoignez des dizaines d'établissements qui ont augmenté leurs avis et leur chiffre
            d'affaires.
          </p>
          <button className="button button-primary button-lg" onClick={scrollToForm}>
            Contactez-nous
          </button>
        </section>
      </main>
